...
DAI_ret_t DAI_mul(DAI_t rop, DAI_t op1, DAI_t op2) { mpz_mul(rop, op1, op2); }
DAI_ret_t DAI_mul_smol_int(DAI_t rop, DAI_t op1, uint32_t op2) { mpz_mul_ui(rop, op1, op2); }
...
DAI_ret_t DAI_cmp(int8_t *rop, DAI_t A, DAI_t B) { *rop = mpz_cmp(A, B); };
